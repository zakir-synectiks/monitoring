...
func (hs *HTTPServer) setIndexViewData(c *m.ReqContext) (*dtos.IndexViewData, error) {
	...
	data.NavTree = append(data.NavTree, &dtos.NavLink{
		...
		Children: []*dtos.NavLink{
			...
			{Text: "Community site", Url: "http://community.grafana.com", Icon: "fa fa-fw fa-comment", Target: "_blank", HideFromMenu: true},
			{Text: "Documentation", Url: "http://docs.grafana.org", Icon: "fa fa-fw fa-file", Target: "_blank", HideFromMenu: true},
		},
	})
