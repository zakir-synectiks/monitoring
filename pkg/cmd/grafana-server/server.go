...
import (
	...
	"github.com/xformation/synectiks-monitoring/pkg/api"
	"github.com/xformation/synectiks-monitoring/pkg/api/routing"
	"github.com/xformation/synectiks-monitoring/pkg/bus"
	"github.com/xformation/synectiks-monitoring/pkg/login"
	"github.com/xformation/synectiks-monitoring/pkg/middleware"
	"github.com/xformation/synectiks-monitoring/pkg/registry"
	"github.com/xformation/synectiks-monitoring/pkg/social"

	"golang.org/x/sync/errgroup"

	"github.com/xformation/synectiks-monitoring/pkg/log"
	"github.com/xformation/synectiks-monitoring/pkg/services/cache"
	"github.com/xformation/synectiks-monitoring/pkg/setting"

	// self registering services
	_ "github.com/xformation/synectiks-monitoring/pkg/extensions"
	_ "github.com/xformation/synectiks-monitoring/pkg/infra/serverlock"
	_ "github.com/xformation/synectiks-monitoring/pkg/metrics"
	_ "github.com/xformation/synectiks-monitoring/pkg/plugins"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/alerting"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/cleanup"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/notifications"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/provisioning"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/rendering"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/search"
	_ "github.com/xformation/synectiks-monitoring/pkg/services/sqlstore"
	_ "github.com/xformation/synectiks-monitoring/pkg/tracing"
)
